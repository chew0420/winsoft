    ...
    <div class="d-flex">
        <div class="main-content p-4" style="width: 100%;">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <a href="{{ url('/superadmin/productList') }}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Back to List</a>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ url('/superadmin/productList/update/'.$product->product_id) }}" enctype="multipart/form-data">
                        @csrf
