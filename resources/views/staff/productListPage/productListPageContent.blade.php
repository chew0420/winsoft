    ...
    <div class="d-flex">
        <div class="main-content p-4" style="width: 100%;">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <a href="{{ url('/staff/productList/addProduct') }}" class="btn btn-primary"><i class="bi bi-plus-circle"></i> Add Product</a>
            </div>
            <div class="card">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/staff/productList/edit/'.$product->product_id) }}" class="btn btn-sm btn-warning">
    ...
    <script>
        function confirmDelete(productId) {
            if(confirm('Are you sure you want to delete this product?')) {
                ...
                form.action = '/staff/productList/delete/' + productId;
                form.submit();
            }
        }
    </script>
