    ...
    <div class="d-flex">
        <div class="main-content p-4" style="width: 100%;">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <a href="{{ url('/staff/categoryList/addCategory') }}" class="btn btn-primary"><i class="bi bi-plus-circle"></i> Add Category</a>
            </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/staff/categoryList/edit/'.$category->category_id) }}" class="btn btn-sm btn-warning">
    ...
    <script>
        function confirmDelete(categoryId) {
            if(confirm('Are you sure you want to delete this category? This action cannot be undone.')) {
                ...
                form.action = '/staff/categoryList/delete/' + categoryId;
                form.submit();
            }
        }
    </script>
